 ...
 * args[1] is the number of columns.  E.g., if it's 5, then BTreeReverseScanTest will end
 * up dumping the contents of f4.0.txt.
 */
public class BTreeReverseScanTest extends SimpleDbTestBase {
    private final static Random r = new Random();

    /** Tests the Reverse scan operator for a table with the specified dimensions. */
    ...
    private static class TupleComparator implements Comparator<ArrayList<Integer>> {
        ...
        public int compare(ArrayList<Integer> t1, ArrayList<Integer> t2) {//降序排列
            int cmp = 0;
